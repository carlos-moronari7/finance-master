...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (FinanceManager::signup($username, $password)) {
        $_SESSION['message'] = ['type' => 'success', 'text' => 'Account created! Please log in.'];
        header("Location: login.php");
        exit;
    } else {
        $_SESSION['message'] = ['type' => 'danger', 'text' => 'Username already taken'];
    }
}
